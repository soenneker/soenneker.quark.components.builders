...
public sealed class ResizeBuilder : ICssBuilder
{
    ...
    internal ResizeBuilder(string resize, Breakpoint? breakpoint = null)
    {
    ...
    public ResizeBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public ResizeBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public ResizeBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public ResizeBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public ResizeBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public ResizeBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private ResizeBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
