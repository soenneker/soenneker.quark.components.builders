...
public sealed class ScrollBehaviorBuilder : ICssBuilder
{
    ...
    internal ScrollBehaviorBuilder(string behavior, Breakpoint? breakpoint = null)
    {
    ...
    public ScrollBehaviorBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public ScrollBehaviorBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public ScrollBehaviorBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public ScrollBehaviorBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public ScrollBehaviorBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public ScrollBehaviorBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private ScrollBehaviorBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
