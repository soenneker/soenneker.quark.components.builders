...
public sealed class AspectRatioBuilder : ICssBuilder
{
    ...
    internal AspectRatioBuilder(string ratio, Breakpoint? breakpoint = null)
    {
    ...
    public AspectRatioBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public AspectRatioBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public AspectRatioBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public AspectRatioBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public AspectRatioBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public AspectRatioBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private AspectRatioBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
