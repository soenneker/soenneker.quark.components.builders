...
public static class BorderRadius
{
    ...
    /// No border radius (0).
    /// </summary>
    public static BorderRadiusBuilder S0 => new(Scale.S0.Value);

    /// <summary>
    /// Small border radius (0.25rem).
    /// </summary>
    public static BorderRadiusBuilder Sm => new("sm");
    ...
    /// </summary>
    public static BorderRadiusBuilder Lg => new("lg");

    /// <summary>
    /// Extra large border radius (1rem).
    /// </summary>
    public static BorderRadiusBuilder Xl => new("xl");
