...
public sealed class BorderRadiusBuilder : ICssBuilder
{
    ...
    internal BorderRadiusBuilder(string size, Breakpoint? breakpoint = null, string cornerToken = "")
    {
    ...
    public BorderRadiusBuilder Xl => ChainWithSize("xl");
    ...
    // ----- Breakpoint chaining -----
    public BorderRadiusBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public BorderRadiusBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public BorderRadiusBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public BorderRadiusBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public BorderRadiusBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private BorderRadiusBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
