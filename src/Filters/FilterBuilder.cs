...
public sealed class FilterBuilder : ICssBuilder
{
    ...
    internal FilterBuilder(string filter, Breakpoint? breakpoint = null)
    {
    ...
    public FilterBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public FilterBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public FilterBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public FilterBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public FilterBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public FilterBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private FilterBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
