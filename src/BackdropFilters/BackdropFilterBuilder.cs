...
public sealed class BackdropFilterBuilder : ICssBuilder
{
    ...
    internal BackdropFilterBuilder(string filter, Breakpoint? breakpoint = null)
    {
    ...
    public BackdropFilterBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public BackdropFilterBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public BackdropFilterBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public BackdropFilterBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public BackdropFilterBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public BackdropFilterBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private BackdropFilterBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
