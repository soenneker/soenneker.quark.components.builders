...
public sealed class CursorBuilder : ICssBuilder
{
    ...
    internal CursorBuilder(string cursor, Breakpoint? breakpoint = null)
    {
    ...
    public CursorBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public CursorBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public CursorBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public CursorBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public CursorBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public CursorBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private CursorBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
